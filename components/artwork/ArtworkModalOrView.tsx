...
export const ArtworkModalOrView: React.FC<ArtworkModalOrViewProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-20 bg-[#0B0B0B]/90 backdrop-blur-md border-b border-[#2A2927] px-6 sm:px-10 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="text-[10px] tracking-[0.3em] uppercase text-[#AAA69D]">
            Katalog Dzieł
          </span>
          <span className="text-[#2A2927]">•</span>
          <span className="text-[11px] text-[#C5A880] tracking-widest">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`p-2 rounded-full border border-[#2A2927] hover:border-[#C5A880] transition-colors ${
              isFavorite ? 'text-[#C5A880] border-[#C5A880]' : 'text-[#AAA69D]'
            }`}
      ...
      <div className="max-w-7xl mx-auto w-full px-5 sm:px-10 py-8 sm:py-14 my-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          {/* LEFT SIDE: Dominant Artwork Canvas (Natural Proportions, No Crop) */}
          <div className="lg:col-span-7 flex flex-col items-center">
            {/* Mobile-Only Sequence Step 1: Exhibition Index */}
            ...
            {/* Museum Wall Presentation */}
            <div className="relative w-full border border-[#2A2927] p-2 sm:p-4 bg-[#111111] shadow-2xl">
              <div
                className="relative w-full aspect-[4/3] sm:aspect-[16/11] overflow-hidden bg-[#0B0B0B] cursor-zoom-in group"
          ...
          {/* RIGHT SIDE: Curatorial Information & Monograph Details */}
      ...
      <div className="sticky bottom-0 z-20 bg-[#0B0B0B]/95 backdrop-blur-md border-t border-[#2A2927] px-6 sm:px-10 py-4 flex items-center justify-between">
        <button
